...
;     The Netherlands   
;
; Typed in and tested from listing in KIM Software 04/03/77, 2021-2022 Hans Otten                       
;
;
; Definitions
;
intrp  = $17fe         ; Non-maskable interrupt trap
nmitrp  = $17fa         ; interrupt break trap
;
; Calculator routines
; (incuded in thsi source, so omitted)
;
;
; General subroutines
;
...
rolwer  rol A           ; shift digit in
        ...
        jmp input
;
; subroutine to read a character form KIM or TTY
; output is in ascii
;
inchar  lda #$01
        bit piadat      ; test if KIM 
        beq ttyin
punt1   jsr scands      ; wait for no key
        bne punt1
punt2   jsr scands      ; wait for a key
        beq punt2
        jsr getkey
        cmp #$15        
        bpl punt1
